...
import { motion } from 'framer-motion'
    ...
    const items = [
            ...
            },
        {
              ...
              sub: "12 Weeks",
                description:
                "Secure, scalable, and high perfomance solutions.",
              image: frame2,
            },
        {
              title: "UI/UX Design",
...
const Course = () => {
  ...
  viewport={{ once: true, amount: 0.2 }}
     className="flex items-center justify-center w-full bg-[rgba(237,255,226,1)]" id='courses'>
        <div className="flex flex-col items-center justify-around w-full h-full ">
            <div className="flex flex-col items-center justify-center w-full b-pink-600 mb-[3rem] sm:mb-[3rem]]">
                <h1 className="text-[2rem] sm:text-[3.2rem] font-semibold text-center  ">Our coureses</h1>
                <p className="sm:text-[1.5rem] text-[0.7rem] w-[80%] sm:w-[60%] text-center">Well tailored and certified courses designed to help you unlock your full career potentials.</p>
            </div>
        <div className="flex flex-wrap items-center justify-center h-[78%] w-full gap-10 "> 
            ...
            className="flex flex-col items-center justify-between rounded-[20px] w-[80%] sm:w-[400px] h-[454px] bg-[rgba(255,255,255,1)] pb-[12px]">
                <div className="flex flex-col items-center justify-center w-full h-[335px]">
                    <div className="flex items-center justify-center w-full h-[50%]"> <img src={item.image} alt="" className="w-full h-full" /> </div>
                <div className="flex flex-col items-center justify-center w-full h-[50%]">
                    ...
                    <p className=" text-center  w-[70%] sm:text-[1.5rem] 562428"> {item.description}</p>
                </div>
                </div>
