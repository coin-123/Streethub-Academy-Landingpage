...
const slidesData = [
  {
    ...
    description:
      "I went from a complete beginner to my first freelance project in a few months, the hands-on workshop gave me the confidence I needed to dive into my career. Streethub Academy transformed my tech jouurney!",
  },
    ...
    >
      <div className="flex flex-col items-center sm:justify-between w-[80%] h-[590px]">
        ...
        <div className="flex items-center justify-center flex-col w-full h-[55%] sm:h-[85%] rounded-[20px] bg-[rgba(12,45,8,1)]">
          <div className="sm:flex items-center justify-between p-4 relative left- top-[200px] w-[100%] hidden ">
            <motion.div
              whileHover={{ x: -5 }}
            ...
            >
              <FaArrowLeft className="  text-[2rem] cursor-pointer text-white   transition duration-300  hover:text-[rgba(81,177,70,1)] " />
            </motion.div>
            <motion.div
              whileHover={{ x: 5 }}
              transition={{ type: "spring", stiffness: 400, damping: 1 }}
            ...
            >
              <FaArrowRight className="text-[2rem] cursor-pointer text-white transition duration-300  hover:text-[rgba(81,177,70,1)] " />
            </motion.div>
          </div>
          <Swiper
